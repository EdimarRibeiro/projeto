...
namespace ProjectManager.Domain.Utils.Expressions
{
    public static class StringExtensions
    {
        public static IList<string> DateTimeFormats { get; } = new List<string> {
            ...
            "d/M/yyyy", "d-M-yyyy", "yyyy/M/d", "yyyy-M-d", "yyyy-MM-dd hh:mm:ss"
        };
        ...
        public static DateTime ToDateTime(this string value, IFormatProvider provider = null)
        {
            ...
            return succeeded ? DateTime.SpecifyKind(result,DateTimeKind.Utc) : throw new FormatException(value == null ? "Can not parse null value to DateTime" : $"String '{value}' was not recognized as a valid DateTime.");
        }
